...
export default function BlogTable({ blogs, onEdit, onDelete }) {
  ...
  return (
    <>
      <Helmet>
        <title>Danh sách bài viết | Dashboard Admin Blog</title>
        <meta
          name="description"
          content="Quản lý, tìm kiếm, chỉnh sửa và xóa các bài viết trên hệ thống Dashboard Admin Blog."
        />
        <meta name="keywords" content="blog, bài viết, dashboard, admin, quản lý" />
      </Helmet>
      <Box>
